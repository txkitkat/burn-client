...
function TemperatureAvgLegend(props: {map: any, isOn: boolean}) {

  //\"http://placehold.it/350x350\" //placeholder image url
  var legendUrl = `${process.env.REACT_APP_FIRE_WINDOW_BACKEND}/temperature_avg_legend`; //For png image
...
export default TemperatureAvgLegend;
